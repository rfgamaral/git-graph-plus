export const en: Record<string, string> = {
  ...
  'details.viewMarkdown': 'Show Markdown',
  'details.viewPlain': 'Show plain text',
  ...
  'checkoutCommit.detachedWarning': 'You will be in detached HEAD state, not on a branch.',
  ...
  'rebase.predictionTruncated': 'Checked the first 20 commits only',
